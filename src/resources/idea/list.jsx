...
const exporter = (posts) => {
  const postsForExport = posts.map((post) => {
    ...
    postForExport.location = postForExport.location
      ? JSON.stringify(postForExport.location)
      : ""; // add a field
...
const BulkEditButton = ({ selectedIds }) => {
  ...
  return (
    <Fragment>
      <Button label="Bulk edit" onClick={handleClick}>
        <ContentCreate />
      </Button>
      <Dialog
