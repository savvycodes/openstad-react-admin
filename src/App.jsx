...
import {
  ...
  IdeaCreate,
  IdeaIcon,
} from "./resources/idea/index.jsx";
import {
  ProductList,
  ProductEdit,
  ProductCreate,
  ProductIcon,
} from "./resources/product.jsx";
...
import {
  ...
  ArgumentCreate,
  ArgumentIcon,
} from "./resources/argument.jsx";
import { SiteEdit, SiteIcon } from "./resources/site/index.jsx";
import {
  NewsletterSignupList,
  NewsletterSignupIcon,
} from "./resources/newslettersignup.jsx";
import {
  ChoicesGuideList,
  ChoicesGuideEdit,
  ChoicesGuideCreate,
  ChoicesGuideIcon,
} from "./resources/choicesGuide/index.jsx";
...
import { OrganisationList } from "./resources/organisation/list.jsx";
import { EditOrganisation } from "./resources/organisation/edit";
import OrganisationIcon from "@material-ui/icons/Apartment";
...
export const OpenstadReactAdmin = (props) => {
  ...
  return (
      ...
      dashboard={(dashboardProps) => {
        return (
          <Dashboard
            ...
            statsApi={
              props.statsApi && props.statsApi.url ? props.statsApi.url : false
            }
          />
        );
      }}
    ...
    >
      {resources.site && resources.site.active ? (
        <Resource
          name="site"
          edit={SiteEdit}
          icon={IdeaIcon}
      ...
      {resources.product && resources.product.active ? (
        <Resource
          name="product"
          list={ProductList}
          edit={ProductEdit}
          ...
          icon={ProductIcon}
          options={{ menuTitle: "Producten", imageApiUrl: props.imageApi.url }}
        />
      ) : (
        <div />
      )}
      {resources.order && resources.order.active ? (
        <Resource
          name="order"
          list={OrderList}
          edit={OrderEdit}
          create={OrderCreate}
          icon={OrderIcon}
          options={{ menuTitle: "Bestellingen" }}
        />
      ) : (
        <div />
      )}
      {resources.idea && resources.idea.active ? (
        <Resource
          name="idea"
          list={IdeaList}
          edit={IdeaEdit}
          ...
          options={{ menuTitle: "Plannen", imageApiUrl: props.imageApi.url }}
        />
      ) : (
        <div />
      )}
      {resources.area && resources.area.active ? (
        <Resource
          name="area"
          list={AreaList}
          edit={AreaEdit}
          ...
          options={{ menuTitle: "Polygonen" }}
        />
      ) : (
        <div />
      )}
      {resources.article && resources.article.active ? (
        <Resource
          name="article"
          list={ArticleList}
          edit={ArticleEdit}
          ...
          icon={ArticleIcon}
          options={{ menuTitle: "Artikelen" }}
        />
      ) : (
        <div />
      )}
      {resources.tag && resources.tag.active ? (
        <Resource
          name="tag"
          list={TagList}
          edit={TagEdit}
          create={TagCreate}
          icon={LocalOfferIcon}
          options={{ menuTitle: "Tags" }}
        />
      ) : (
        <div />
      )}
      {resources.argument && resources.argument.active ? (
        <Resource
          name="argument"
          list={ArgumentList}
          edit={ArgumentEdit}
          ...
          icon={ArgumentIcon}
          options={{ menuTitle: "Argumenten" }}
        />
      ) : (
        <div />
      )}
      {resources.vote && resources.vote.active ? (
        <Resource
          name="vote"
          list={VoteList}
          icon={HowToVoteIcon}
          options={{ menuTitle: "Stemmen" }}
        />
      ) : (
        <div />
      )}
      {resources.user && resources.user.active ? (
        <Resource
          name="user"
          list={UserList}
          edit={UserEdit}
          create={UserCreate}
          icon={UserIcon}     
          options={{ menuTitle: "Gebruikers", userPath: userPath }}
        />
      ) : (
        <div />
      )}
      {resources.newsletterSignup && resources.newsletterSignup.active ? (
        <Resource
          name="newslettersignup"
          list={NewsletterSignupList}
          icon={ContactMailIcon}
          options={{ menuTitle: "Nieuwsbrief" }}
        />
      ) : (
        <div />
      )}
      {resources.choicesGuide && resources.choicesGuide.active ? (
        <Resource
          name="choicesGuide"
          list={ChoicesGuideList}
          edit={ChoicesGuideEdit}
          create={ChoicesGuideCreate}
          icon={ChoicesGuideIcon}
          options={{ menuTitle: "Keuzewijzers" }}
        />
      ) : (
        <div />
      )}
      {resources.organisation && resources.organisation.active ? (
        <Resource
          name="organisation"
