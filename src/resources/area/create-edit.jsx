...
const Form = (props) => (
  <SimpleForm {...props}>
    ...
    <p>
      ...
      has many options at the   <a href="https://maps.amsterdam.nl/open_geodata/?LANG=nl" target="_blank">Amsterdam map site.</a>
      It's also possible to visually create our own polygon in the right format here: <a href="https://geojson.io/" target="_blank"> geojson.io</a>
    </p>
    <p>
